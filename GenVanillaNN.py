...
class GenNNSkeToImage(nn.Module):
    ...
    def __init__(self):
        ...
        self.model = nn.Sequential(
            # Step 1: First ConvTranspose2d layer to expand from (26, 1, 1) to (128, 4, 4)
            nn.ConvTranspose2d(self.input_dim, 128, kernel_size=4, stride=1, padding=0),  # (26, 1, 1) -> (128, 4, 4)
            nn.BatchNorm2d(128),
            nn.ReLU(True),
            ...
            nn.ConvTranspose2d(32, 16, kernel_size=4, stride=2, padding=1),  # (32, 16, 16) -> (16, 32, 32)
            nn.BatchNorm2d(16),
            nn.ReLU(True),

            # Final layer: Output 3 channels for RGB instead of 1 for grayscale
            nn.ConvTranspose2d(16, 3, kernel_size=4, stride=2, padding=1),  # (16, 32, 32) -> (3, 64, 64)
...
class GenVanillaNN():
    ...
    def __init__(self, videoSke, loadFromFile=False, optSkeOrImage=1):
        ...
        src_transform = None
        self.filename = 'models/DanceGenVanillaFromSke.pth'
